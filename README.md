...
(devel → staging → production), substituindo automaticamente as conexões conflitantes de banco de dados.
...
git clone https://github.com/w4lto/superset-migrator
...
(ex: `dashboard_1_vendas_staging`). A ferramenta usa essa URL como chave:
...
? Slug do dashboard: dashboard_1_vendas_staging
✓ Dashboard encontrado: Vendas homologação 1s2026 (ID: 42)
```
